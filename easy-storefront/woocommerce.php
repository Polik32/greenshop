...
$easy_storefront_content = 'col-sm-8 col-md-8 col-lg-9 col-xs-12';
...
<div class="container background">
   <div class="row">
   			...
   			<div class="col-md-4 col-sm-4 col-lg-3  col-xs-12 floateleft  <?php echo $easy_storefront_sidebar; ?>" > 
